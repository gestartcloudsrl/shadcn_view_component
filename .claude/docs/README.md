...
| [features/message-scroller.md](features/message-scroller.md) | the message scroller before any of it is written: what shadcn's own primitive contains, measured, and the two surfaces deliberately left out |
